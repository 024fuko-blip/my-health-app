...
export function PetFeedTab({ data, onFeed, onBuy }: PetFeedTabProps) {
  return (
    <div className="space-y-4">
      <h3 className="font-bold text-slate-800">所持している餌</h3>
          ...
          {data.foods
            ...
            .map((f) => (
              ...
              >
                ...
                <span className="text-sm text-slate-700">x{f.owned}</span>
              </button>
            ))}
        </div>
      )}
      <h3 className="font-bold text-slate-800 pt-2">ショップ（餌）</h3>
