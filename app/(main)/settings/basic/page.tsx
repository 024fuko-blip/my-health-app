  ...
  return (
    <div className="space-y-6">
      <div className="bg-white p-4 rounded-xl border space-y-4">
        <h3 className="font-bold text-slate-800">使用モード</h3>
      ...
      <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-3">
        ...
        <p className="text-sm text-slate-700">相棒の話し方を選べます</p>
        <div className="space-y-2">
          {[
            ...
            >
              ...
              {settings.ai_personality === value && <span className="text-xs text-slate-800 font-medium">✓ 使用中</span>}
            </button>
          ))}
        </div>
      </div>
