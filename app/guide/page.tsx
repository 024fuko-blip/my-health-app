      ...
      <div className="mx-auto w-full max-w-2xl space-y-5">
        ...
        <section className="rounded-2xl bg-white p-5 shadow-sm border border-slate-200">
          ...
          <div className="space-y-3 pl-12 text-sm text-gray-600">
            ...
            <p>
              日次タブでは最上部に<strong>今日の体調</strong>カードを表示。グラフ・心身スコア・相関マップ・オネエ総評は折りたたみ可能で、最初はオネエ総評とグラフを開いた状態です。色はスレート系に統一し、認知負荷を軽減しています。
            </p>
            ...
            <p>
              分析画面の「日次」タブで「週間 (7日間)」「月間 (30日間)」トグルで表示期間を切り替えられます。体調・腹痛・トイレ・気分・体重・アルコールなどの項目を選んでグラフに追加でき、「オネエの期間総評」も表示されます。同一期間はキャッシュされ、毎回のAPI呼び出しを抑えます。
            </p>
