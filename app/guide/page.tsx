      ...
      <div className="mx-auto w-full max-w-2xl space-y-5">
        ...
        <section className="rounded-2xl bg-white/90 p-5 shadow-sm border border-green-100/80">
          ...
          <div className="space-y-2 pl-12 text-sm text-gray-600">
            ...
            <p>
              <strong>🤖 LINEで相談</strong> … 連携後は何でも相談できる相棒モード。既往歴・服薬（副作用・飲み合わせ）・年齢・性別・生理周期・IBDなどアプリで設定した情報を前提に、AIが答えます。友だち追加時や返信には「今日の記録」「ペットを見る」などのボタンが表示され、ワンタップでアプリを開けます。
            </p>
            <p>
              <strong>📋 Rich Menu</strong> … 設定画面のLINE連携カードにある「Rich Menu を設定」ボタンで、チャット下部に「今日の記録」「ペット」「分析」「相談」の4つメニューを表示できます。一度設定すれば全ユーザーに反映されます。
            </p>
            <p>
