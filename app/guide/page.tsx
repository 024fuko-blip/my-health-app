      ...
      <div className="mx-auto w-full max-w-2xl space-y-5">
        ...
        <section className="rounded-2xl bg-white p-5 shadow-sm border border-slate-200">
          ...
          <div className="space-y-2 pl-12 text-sm text-gray-600">
            ...
            <p>
              <strong>📋 Rich Menu</strong> … 友だち追加した瞬間に、チャット下部に「記録」「今日の体調予想」「ペット」「分析」の4つメニューが自動で表示されます。記録・ペット・分析はアプリの各ページへ、今日の体調予想は過去1週間の健康データ・天気・花粉・黄砂・生理情報からAIが今日の体調を予測してLINEで返信します。ぽっちは進化システム・部屋カスタマイズ・ミニゲーム（おやつキャッチ・なでなで・健康クイズ）で育成できます。
            </p>
            <p>
