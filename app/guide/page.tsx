      ...
      <div className="mx-auto w-full max-w-2xl space-y-5">
        ...
        <section className="rounded-2xl bg-white p-5 shadow-sm border border-slate-200">
          ...
          <p className="text-sm text-gray-600 pl-12 mt-2">
            <strong>かんたん記録</strong> … 記録画面の上にあるオレンジのボタンから「かんたん記録」に入ると、1枚ずつカード形式で大きなボタンを使って入力できます。スキップもできるので、忙しい日でもサクッと記録できます。
          </p>
          <p className="text-sm text-gray-600 pl-12 mt-2">
        ...
        <section className="rounded-2xl bg-white p-5 shadow-sm border border-slate-200">
          ...
          <div className="space-y-2 pl-12 text-sm text-gray-600">
            ...
            <p>
              <strong>ぽっち（ペット育成）</strong> … ゲーム画面の「ぽっち」カード、または「ぽっちを育てる」からペットを迎えられます。たまったポイントで<strong>餌</strong>（幸福度アップ）や<strong>着せ替え</strong>（リボン・帽子・マフラーなど）を購入して、ぽっちを育てましょう。餌は所持分から「あげる」、衣装は購入後に「着せ替え」で装着できます。「遊ぶ」タブでは<strong>6×6数独</strong>・<strong>神経衰弱</strong>（健康用語のペア）・なでなで・健康クイズのミニゲームでポイントと幸福度をゲットできます。
            </p>
            <p>
              <strong>ねこ8段階進化 × 記録EXP連動</strong> … ねこを選んで迎えたぽっちは、健康記録をすると<strong>EXP（経験値）</strong>がたまります。記録した、食事を入力した、睡眠の質が良い、体調が良い、3日以上連続記録などでボーナスEXPが付きます。EXPがたまると<strong>8段階で進化</strong>し、ユメたまご・よちよちベビー・液体ねこ・夢の板前さん・銀河の王様・夢守神(守護獣)など、段階ごとに違う動きと姿を楽しめます。他5種類（いぬ・うさぎ・カピバラ・ハムスター・アヒル）は従来の3ステージ（ベビー→ジュニア→アダルト）です。
            </p>
            <p>
              <strong>歩数目標達成リアクション</strong> … ボディメイクモードをONにして、今日の歩数が8,000歩以上になると、分析画面（ホーム）を開いたときにわんぱくチャイルドが猫じゃらしに飛びつく演出が出ます。1日1回まで表示されます。
            </p>
            <p>
              <strong>液体ねこコレクション</strong> … ねこを育てている場合、「液体」タブで、過去3日間の食事メモ＋カロリーorタンパク質記録が続くと容器（マグカップ・箱など）がアンロックされます。液体化したねこが容器に「とろ〜ん」と収まった姿を、スマホを傾けると揺れる演出で楽しめます。
            </p>
            <p>
              <strong>気ままな青年のSNS風メッセージ</strong> … ねこがLv.5以上になると、分析画面（ホーム）でサングラスをかけたねこがスマホをぺしぺし叩きながら、昨日の歩数・睡眠データに基づいた生意気なアドバイスを吹き出しで届けてくれる。歩数が少ないと「昨日はサボったな？」、睡眠が良いと「良い睡眠じゃん」など。
            </p>
            <p>
        ...
        <section className="rounded-2xl bg-white p-5 shadow-sm border border-slate-200">
          ...
          <div className="space-y-2 pl-12 text-sm text-gray-600">
            ...
            <p>
              <strong>📋 Rich Menu</strong> … 友だち追加した瞬間に、チャット下部に「記録」「今日の体調予想」「ペット」「分析」の4つメニューが自動で表示されます。記録・ペット・分析はアプリの各ページへ、今日の体調予想は過去1週間の健康データ・天気・花粉・黄砂・生理情報からAIが今日の体調を予測してLINEで返信します。ぽっちは進化システム・部屋カスタマイズ・ミニゲーム（6×6数独・神経衰弱・なでなで・健康クイズ）で育成できます。
            </p>
            <p>
        ...
        <section className="rounded-2xl bg-white p-5 shadow-sm border border-slate-200">
          ...
          <div className="space-y-3 pl-12 text-sm text-gray-600">
            ...
            <ul className="list-disc pl-4 space-y-1">
              ...
              <li><strong>健康管理</strong> … 生理周期（最後の生理開始日・周期・期間）と、服薬中の薬と服用タイミング（朝・昼・晩・眠前）。「カレンダー・記録画面に生理周期を表示する」でON/OFFを切り替えられます。<strong>薬はNDBオープンデータ（約8,000品目）から候補を検索</strong>して登録でき、AIアドバイスに薬効分類・後発品情報が活用されます。服薬リマインダーで使う表示時刻もここで設定できます。分析画面では服薬中の薬ごとに「PMDAで副作用を確認する」リンクが表示されます。</li>
